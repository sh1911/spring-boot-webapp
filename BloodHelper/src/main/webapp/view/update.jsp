  ...
  <div class="module">
    ...
    <form class="form" action="/user/saveUser" method="post" autocomplete="off">
      ...
      <table style="float:left">
		...
		<tr style="border:1px">
    	<th colspan="2" >Old Password <em style="color:red;" >* </em><input type="password" id="oldpassword" name="oldpassword" required="required" /></th>
     	</tr>
     	<tr style="border:1px">
    	<th colspan="2">New Password<em style="color:red;" >* </em><em>required if update password </em>  <input type="password" title="Password must contain at least 8 characters, including 1-UPPER,1-Lowercase,1-Numbers and one specialcharcter[@#$%] " pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).{8,12}" name="newpassword" id="newpassword"  /></th>
     	</tr>
     	<tr>
